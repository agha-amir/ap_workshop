...
template<typename T>
Vector<T>::Iterator::Iterator(T* pointer) : p(pointer) {}
...
template<typename T>
bool Vector<T>::Iterator::operator==(const Iterator& o) {
    return this->p == o.p;
}
...
template<typename T>
typename Vector<T>::Iterator Vector<T>::begin() {return Iterator(arrayOfElements);}

template<typename T>
typename Vector<T>::Iterator Vector<T>::end() {return Iterator(arrayOfElements + size);}
